...
public class InvalidUsernameException extends RuntimeException{
    ...
    static final String[] blacklistedUsernames = new String[]{"admin", "administrator", "root", "sysadmin", "test", "guest", "demo", "support", "help", "api", "guestuser", "anonymous", "default", "sql", "mysql", "user", "username"};
