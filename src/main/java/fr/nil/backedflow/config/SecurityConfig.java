...
private final AuthenticationProvider authenticationProvider;
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:4200","http://192.168.1.18:4200","http://api.transfer-flow.com","http://api.transfer-flow.com","http://transfer-flow.com","https://transfer-flow.com")); // allow all origins
